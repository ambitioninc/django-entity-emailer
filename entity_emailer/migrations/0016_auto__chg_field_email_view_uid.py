...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Email.view_uid'
        db.alter_column(u'entity_emailer_email', 'view_uid', self.gf('uuidfield.fields.UUIDField')(default='00000000000000000000000000000000', unique=True, max_length=32))

    def backwards(self, orm):

        # Changing field 'Email.view_uid'
        db.alter_column(u'entity_emailer_email', 'view_uid', self.gf('uuidfield.fields.UUIDField')(unique=True, max_length=32, null=True))
