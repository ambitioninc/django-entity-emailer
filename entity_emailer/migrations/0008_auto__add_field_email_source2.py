...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Email.source2'
        db.add_column(u'entity_emailer_email', 'source2',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entity_event.Source'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Email.source2'
        db.delete_column(u'entity_emailer_email', 'source2_id')
    ...
    models = {
        ...
        u'entity_emailer.email': {
            ...
            'source2': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['entity_event.Source']", 'null': 'True'}),
