...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Email.event'
        db.add_column(u'entity_emailer_email', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entity_event.Event'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Email.event'
        db.delete_column(u'entity_emailer_email', 'event_id')
    ...
    models = {
        ...
        u'entity_emailer.email': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['entity_event.Event']", 'null': 'True'}),
