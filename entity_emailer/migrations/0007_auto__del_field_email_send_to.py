...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Email.send_to'
        db.delete_column(u'entity_emailer_email', 'send_to_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Email.send_to'
        raise RuntimeError("Cannot reverse this migration. 'Email.send_to' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Email.send_to'
        db.add_column(u'entity_emailer_email', 'send_to',
