...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Email.subentity_kind'
        db.add_column(u'entity_emailer_email', 'subentity_kind',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['entity.EntityKind'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Email.subentity_kind'
        db.delete_column(u'entity_emailer_email', 'subentity_kind_id')
