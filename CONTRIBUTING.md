...
[ambitioninc repository](https://github.com/ambitioninc/django-entity-emailer/issues).
...
```bash
git clone git://github.com/ambitioninc/django-entity-emailer.git
cd django-entity-emailer
virtualenv env
. env/bin/activate
...
* Bump version in entity_emailer/version.py
